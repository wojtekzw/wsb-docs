...
6. Alokacja kosztów wspólnych na kategorie produktów
7. Wyszukiwanie optymalnej struktury sprzedaży
...
### Część 6: Analiza rentowności (75 minut)

1. **Import dodatkowych danych:**
   - Zaimportuj dane z plików:
     - `katalog_produktow.csv`
     - `kategorie_logistyczne.csv`
     - `koszty_wspolne.csv`
     - `klucze_alokacji.csv`
   - Utworzy relacje między tabelami z wykorzystaniem powiązania produktów i kategorii

   > **Podpowiedź:** Możesz użyć funkcji Power Query (Pobieranie danych) do zaimportowania i przekształcenia danych. W nowszych wersjach Excela znajdziesz te opcje w zakładce "Dane".

2. **Utworzenie arkusza "Analiza_Kosztow":**
   - Utwórz nowy arkusz o nazwie "Analiza_Kosztow"
   - Przygotuj tabele z kosztami dla każdej kategorii produktów
   - Oblicz miesięczne koszty wspólne przypisane do poszczególnych kategorii na podstawie kluczy alokacji

   > **Podpowiedź:** Użyj funkcji SUMIF lub SUMIFS, aby sumować koszty na podstawie wielu kryteriów. Możesz również wykorzystać tabele przestawne do analizy kosztów.

3. **Utworzenie arkusza "Rentowność":**
   - Utwórz nowy arkusz o nazwie "Rentowność"
   - Oblicz następujące wskaźniki dla każdej kategorii produktów i dla każdego miesiąca:
     - Przychód ze sprzedaży
     - Koszt zakupu sprzedanych produktów
     - Koszty logistyczne
     - Marża brutto (Przychód - Koszt zakupu - Koszty logistyczne)
     - Marża brutto procentowo
     - Koszty wspólne przypisane do kategorii
     - Zysk netto (Marża brutto - Koszty wspólne)
     - Rentowność sprzedaży (Zysk netto / Przychód)

   > **Podpowiedź:** Użyj tabel przestawnych do agregacji danych sprzedażowych, a następnie wykorzystaj funkcje tablicowe lub funkcje wyszukiwania (np. WYSZUKAJ.PIONOWO) do przypisania odpowiednich kosztów.

4. **Analiza rentowności produktów:**
   - Zidentyfikuj najbardziej i najmniej rentowne produkty w każdej kategorii
   - Przeanalizuj wpływ kosztów logistycznych na rentowność różnych kategorii produktów
   - Przygotuj wykres porównujący marżę brutto i rentowność sprzedaży dla różnych kategorii

   > **Podpowiedź:** Użyj formatowania warunkowego, aby wizualnie podkreślić najbardziej i najmniej rentowne produkty. Możesz również wykorzystać rankingi w tabelach przestawnych, aby automatycznie identyfikować najlepsze i najgorsze produkty pod względem rentowności.

### Część 7: Optymalizacja struktury sprzedaży (45 minut)

1. **Utworzenie arkusza "Optymalizacja":**
   - Utwórz nowy arkusz o nazwie "Optymalizacja"
   - Przygotuj model do analizy wpływu zmiany struktury sprzedaży na całkowitą rentowność

2. **Model optymalizacyjny:**
   - Utwórz tabelę z obecną strukturą sprzedaży (udział poszczególnych kategorii)
   - Dodaj możliwość modyfikacji struktury sprzedaży (procentowe udziały kategorii)
   - Oblicz wpływ zmienionej struktury na:
     - Całkowity przychód
     - Całkowitą marżę brutto
     - Całkowity zysk netto
     - Średnią rentowność sprzedaży

   > **Podpowiedź:** Użyj formuł warunkowych i odwołań do komórek, aby dynamicznie obliczać zmiany w przychodach i kosztach w zależności od zmodyfikowanej struktury sprzedaży.


4. **Rekomendacje biznesowe:**
   - Na podstawie przeprowadzonych analiz przygotuj zestaw rekomendacji dotyczących:
     - Optymalizacji struktury sprzedaży
     - Potencjalnych zmian w marżach lub cenach
     - Optymalizacji kosztów logistycznych
     - Realokacji kosztów wspólnych

   > **Podpowiedź:** Użyj wykresów i tabel do wizualizacji potencjalnych korzyści z wdrożenia rekomendacji. Możesz również przygotować prosty raport podsumowujący kluczowe rekomendacje i ich szacowany wpływ na wyniki finansowe.
